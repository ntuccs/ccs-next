export const website = {
  title: 'Center for China Studies, National Taiwan University',
  description:
    'Welcome to Center for China Studies, National Taiwan University. We endeavor to establish Taiwan’s major research-oriented center, with far-reaching influence in Asia and around the globe, on contemporary China’s domestic and international affairs.',
};
  ...
  list: [
    {
      ...
      image: '/members/cjt.jpg',
    },
    {
      name: 'S. Philip Hsu',
      position: 'Executive Director',
      image: '/members/xsq.jpg',
    },
    {
      name: 'George Yin',
      position: 'Senior Research Fellow',
      image: '/members/ylj.jpg',
    },
  ],
};
